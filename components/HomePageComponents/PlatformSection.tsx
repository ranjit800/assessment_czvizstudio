      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="flex flex-col text-center md:text-left">
            ...
            <motion.p variants={itemVariants} className="text-neutral-300 mb-8">
              <span className="text-orange-400">Sell 3D Models, E-books, and digital products</span> effortlessly. Manage your store, deliver products seamlessly, and reach a global audience.
            </motion.p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-16 md:mt-24 text-center">
          <motion.div variants={itemVariants} className="md:w-1/3 p-4">
            <h3 className="text-xl font-bold">Global</h3>
            <p className="text-orange-400">For creators worldwide.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="md:w-1/3 p-4">
            <h3 className="text-xl font-bold">Earnings</h3>
            <p className="text-orange-400">Keep 100% of what you earn.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="md:w-1/3 p-4">
            <h3 className="text-xl font-bold">Support</h3>
            <p className="text-orange-400">We&apos;ve got your back.</p>
          </motion.div>
        </div>
      </motion.div>
    </div>
